# -*- coding: utf-8 -*-
"""
Created on Mon Aug 19 12:58:48 2019
...
glass= pd.read_csv("C:\\Users\\Hello\\Desktop\\Data science\\data science\\assignments\\KNN\\Datasets\\glass.csv")
...
##Finding the accuracy of the model on training data
 train_accuracy = np.mean(model.predict(x_train)==y_train) ##71.875%
 
##Accuracy on test data
test_accuracy = np.mean(model.predict(x_test)==y_test) ##59.30%
